...
{
  public class AgentSystem : GH_Goo<Object>
  {
    ...
    public T.AgentSystem(AgentType[] agentsSettings, EmitterType[] emitters, 
    ...
    public T.AgentSystem(T.AgentSystem system)
    {
    ...
    public override bool Equals(object obj) //ToDo fix bugs in equals
    {
      ...
      T.AgentSystem s = obj as T.AgentSystem;
    ...
    public bool Equals(T.AgentSystem s) //ToDo fix bugs in equals
    {
      // If parameter is null return false:
      if ((object)s == null)
      {
