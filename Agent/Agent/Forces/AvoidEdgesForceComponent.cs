...
{
  public class AvoidEdgesForceComponent : GH_Component
  {
    /// <summary>
    /// Initializes a new instance of the AvoidEdgesForceComponent class.
    /// </summary>
    public AvoidEdgesForceComponent()
      : base("AvoidEdgesForce", "AvoidEdges",
          "Avoid Edges Force",
          "Agent", "Forces")
    {
    }
    ...
    {
      pManager.AddGenericParameter("Avoid Edges Force", "F", "Avoid Edges Force", GH_ParamAccess.item);
    }
    ...
    protected override void SolveInstance(IGH_DataAccess DA)
    {
      ...
      AvoidEdgesForceType force = new AvoidEdgesForceType(weight, 
