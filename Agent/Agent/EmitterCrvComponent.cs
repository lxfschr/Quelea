...
namespace Agent
{
    public class EmitterCrvComponent : GH_Component
    {
        /// <summary>
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            EmitterCrvType emitter = createEmitter(crv, continuousFlow, creationRate, numAgents);
        ...
        private EmitterCrvType createEmitter(Curve crv, bool continuousFlow, int creationRate, int numAgents)
        {
            return new EmitterCrvType(crv, continuousFlow, creationRate, numAgents);
        }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                //return null;
                return Properties.Resources.emitterCrvIcon;
            }
        }
