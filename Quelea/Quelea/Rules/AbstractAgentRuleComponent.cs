...
namespace Quelea
{
  public abstract class AbstractAgentRuleComponent : AbstractRuleComponent
  {
    ...
    /// </summary>
    protected AbstractAgentRuleComponent(string name, string nickname, string description, 
