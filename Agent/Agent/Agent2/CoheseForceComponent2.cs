...
{
  public class CoheseForceComponent2 : GH_Component
  {
    /// <summary>
    /// Initializes a new instance of the CoheseForceComponent class.
    /// </summary>
    public CoheseForceComponent2()
      : base("Cohese Force", "Cohese2",
          "Cohesion",
          "Agent", "Agent2")
    {
    }
    ...
    protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
    {
      ...
      pManager.AddGenericParameter("Neighbors", "N", "The neighbors to react to.", GH_ParamAccess.list);
    }
    ...
    protected override void SolveInstance(IGH_DataAccess DA)
    {
      ...
      if (!DA.GetDataList(1, neighbors)) return;
    ...
    private Vector3d run(AgentType agent, List<AgentType> neighbors)
    {
      Vector3d force = calcForce(agent, neighbors);
    ...
    {
      get { return new Guid("{f01f1efc-d42d-4393-b5bc-e4daab3c64c8}"); }
    }
  }
}