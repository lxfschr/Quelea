...
{
  public class T.AgentSystem : GH_Component
  {
    /// <summary>
    /// Initializes a new instance of the T.AgentSystemComponent class.
    /// </summary>
    public T.AgentSystem()
      : base("T.AgentSystem", "System",
    ...
    protected override void SolveInstance(IGH_DataAccess DA)
    {
      ...
      T.AgentSystem system = new T.AgentSystem(agents.ToArray(), emitters.ToArray(), environment, forces.ToArray(), behaviors.ToArray());
