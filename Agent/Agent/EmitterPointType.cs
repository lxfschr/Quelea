...
namespace Agent
{
    public class EmitterPointType : EmitterType
    {
        ...
        public EmitterPointType(Point3d pt, bool continuousFlow, int creationRate, int numAgents)
        {
            this.pt = pt;
        ...
        // Constructor with initial values.
        public EmitterPointType(Point3d pt)
        {
            this.pt = pt;
            this.continuousFlow = true;
            this.creationRate = 1;
        ...
        // Copy Constructor
        public EmitterPointType(EmitterPointType ptEmitType)
        {
        ...
        {
            return new EmitterPointType(this);
        }
