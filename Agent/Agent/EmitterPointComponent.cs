...
namespace Agent
{
    public class EmitterPointComponent : GH_Component
    {
        /// <summary>
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            EmitterPointType emitterPt = createEmitter(pt, continuousFlow, creationRate, numAgents);
        ...
        private EmitterPointType createEmitter(Point3d pt, bool continuousFlow, int creationRate, int numAgents)
        {
            return new EmitterPointType(pt, continuousFlow, creationRate, numAgents);
        }
